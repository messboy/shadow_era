...
!function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.trigger('post-body');
          ...
          //0928:andy tooltip img
          $( "td.Name-cell" ).each(function( index ) {
            // console.log( index + ": " + $( this ).text() );
            var id = $(this).parent().find(".ID-cell").text()
             $(this).html('<label><a href="/#" title="<img src='+ 'http://www.shadowera.com/cards/'+ id +'.jpg style=width:250px'+ '/>" data-html="true" rel="tooltip" >'+ $( this ).text() +'</a></label>');
          });

          $("td.Name-cell").tooltip({
